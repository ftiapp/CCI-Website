...
export default function Footer({ locale }) {
  ...
  return (
    <footer className="bg-earth-800 text-earth-100 py-12" role="contentinfo">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <div>
                ...
                <p className="text-sm font-prompt text-earth-300">
          ...
          {/* ส่วนที่ 2: เมนูนำทาง */}
          <div className="lg:col-span-1">
            <h3 className="text-lg font-prompt font-semibold text-beige-300 mb-3">
              {t.footer.quickLinks}
            </h3>
            <nav aria-label="Footer navigation">
              <ul className="space-y-2">
                <li>
                  <Link 
                    href={`/${locale}`} 
                    className="text-sm font-prompt text-earth-300 hover:text-beige-300 transition-colors duration-200 inline-block"
                  >
                    {t.nav.home}
                  </Link>
                </li>
          ...
          <div className="lg:col-span-1">
            ...
            <div className="space-y-2">
              <div className="text-sm font-prompt text-earth-300">
              ...
              <div className="text-sm font-prompt text-earth-300">
                <p className="flex items-center space-x-2">
                  <span className="inline-block w-4 text-earth-400">✉️</span>
                  <a 
            ...
            {/* Social Media */}
            <div className="mt-4">
              <h4 className="text-sm font-prompt font-medium text-beige-300 mb-2">
                ติดตามเรา
              </h4>
              <a 
                ...
                className="inline-flex items-center text-earth-300 hover:text-beige-300 transition-colors duration-200"
          ...
          <div className="lg:col-span-1">
            ...
            {/* Contact Person 1 */}
            <div className="mb-3 p-3 bg-earth-700/50 rounded-lg">
              <h4 className="text-sm font-prompt font-medium text-beige-300 mb-1">
                ฑิตยา น้อยถนอม
              </h4>
              ...
              <div className="space-y-1">
                <p className="text-xs font-prompt text-earth-300">
                  ...
                  <a 
                    ...
                    className="hover:text-beige-300 transition-colors duration-200 ml-1"
                  >
                    thittayan@fti.or.th
                  </a>
                </p>
            ...
            {/* Contact Person 3 */}
            <div className="mb-4 p-3 bg-earth-700/50 rounded-lg">
              <h4 className="text-sm font-prompt font-medium text-beige-300 mb-1">
            ...
            {/* Working Hours */}
            <div className="p-3 bg-earth-700/30 rounded-lg">
              <h4 className="text-sm font-prompt font-medium text-beige-300 mb-1">
                เวลาทำการ
              </h4>
              <p className="text-xs font-prompt text-earth-300">
        ...
        <div className="mt-8 pt-6 border-t border-earth-700">
          <div className="text-center text-sm font-prompt text-earth-400">
            <p>&copy; {currentYear} Climate Change Institute, Federation Of Thai Industries. {t.footer.allRightsReserved}</p>
            <div className="mt-3 flex justify-center space-x-4">
              <Link 
                href={`/${locale}/terms`} 
                className="text-xs font-prompt text-earth-400 hover:text-beige-300 transition-colors duration-200"
              >
